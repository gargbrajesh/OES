	...
	<div align="center" class="tag">
		<form action="#" method="POST" autocomplete="off"><br>
			<table style="margin-bottom: 60px;">
				...
				<tr align="center">
					<td colspan="4"> <a href="forgot_pass.php"
							style="color:rgb(12, 199, 199); text-decoration:none;">Forgot Password</a></td>
				</tr>
				<tr align="center">
     ...
     if(isset($_POST['login']))
         {
			...
			$query = "select * from admin_login where email = '$email' or password ='$password'";
